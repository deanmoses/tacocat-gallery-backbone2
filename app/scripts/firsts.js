'use strict';
/**
 * Backbone models & views representing and displaying Tacocat photo gallery firsts
 */

// tell JSHint to assume existence of these global vars
/*global app, $, _, Backbone, Handlebars, alert, Router, Authentication, Album, Photo*/
